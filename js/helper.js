function calculate(data) {
    ...
    var taxfree     = getFloatValue(data.taxfree);
    ...
    if (data.year_2013.is(':checked'))
        ...
        {year = 2010;}
    else if (data.year_2014.is(':checked'))
        {year = 2014;}
    ...
    if (year == 2010)
        ...
        {pr1 = 0.02;}
    else if (data.pen_pr2.is(':checked') && year == 2014)
        {pr1 = 0.02;}
    else if (data.pen_pr3.is(':checked') && year == 2014)
        {pr1 = 0.03;}
    else
        {pr1 = 0.02;}
    ...
    data.localtaxes.val(round(1 * data.gross_sallary.val() * loc, 3));
    data.pension.val(round(data.gross_sallary.val() * (pr1 + pr2), 3));
